...
# import numpy as np
# p1_test = np.random.rand(N)
# f1_test = np.random.rand(N)
# p2_test = np.random.rand(N)
# f2_test = np.random.rand(N)
# print(f'Expected winnings for player 1: {compute_expected_winning_P1(p1_test, f1_test, p2_test, f2_test)}')
# print(f'Expected winnings for player 1: {compute_expected_winning_P1(p2_test, f2_test, p1_test, f1_test)}')
